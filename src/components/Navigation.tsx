...
const Navigation = ({ currentPage, onPageChange }: NavigationProps) => {
  ...
  const navItems = [
    ...
    { id: 'colleges', label: 'Explore Colleges', icon: Map }
  ];
    ...
    <>
      ...
      <nav className="md:hidden fixed top-0 left-0 right-0 z-50 glass-card border-b border-white/10">
        <div className="px-4 py-3">
          <div className="flex justify-between items-center">
            {/* Logo */}
            <div className="flex items-center space-x-2" onClick={() => onPageChange('home')}>
          ...
          <div className="absolute top-full left-0 right-0 glass-card border-t border-white/10 shadow-float">
            <div className="p-4 space-y-2">
              ...
              <div className="pt-2 border-t border-white/10">
                <Button variant="outline" size="sm" className="w-full glass-card border-primary/30">
                  <User className="w-4 h-4 mr-2" />
                  Profile
                </Button>
              </div>
