...
const quizQuestions: QuizQuestion[] = [
  {
    ...
    options: [
      {
        id: "build",
        text: "Building something with my hands",
        emoji: "🔧",
        category: "builder",
      },
      {
        id: "read",
        text: "Reading books or solving puzzles",
        emoji: "📚",
        category: "analyst",
      },
      {
        id: "create",
        text: "Drawing, music, or creative projects",
        emoji: "🎨",
        category: "creator",
      },
      {
        id: "help",
        text: "Helping family or volunteering",
        emoji: "❤️",
        category: "helper",
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        id: "research",
        text: "Do the research and analysis",
        emoji: "🔍",
        category: "analyst",
      },
      {
        id: "design",
        text: "Handle presentation and design",
        emoji: "✨",
        category: "creator",
      },
      {
        id: "support",
        text: "Support others and keep peace",
        emoji: "🤝",
        category: "helper",
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        id: "express",
        text: "Expressing ideas creatively",
        emoji: "🎭",
        category: "creator",
      },
      {
  ...
  },
  {
    ...
    options: [
      {
        id: "hands-on",
        text: "Hands-on practice and doing",
        emoji: "🛠️",
        category: "builder",
      },
      {
        id: "theory",
        text: "Understanding theory first",
        emoji: "📖",
        category: "analyst",
      },
      {
        id: "visual",
        text: "Visual examples and stories",
        emoji: "🎬",
        category: "creator",
      },
      {
        id: "discussion",
        text: "Group discussions and sharing",
        emoji: "💬",
        category: "helper",
      },
    ],
  },
  {
    ...
    options: [
      {
        id: "practical",
        text: "Practical and determined",
        emoji: "💪",
        category: "builder",
      },
      {
        id: "logical",
        text: "Logical and detail-oriented",
        emoji: "🎯",
        category: "analyst",
      },
      {
        id: "imaginative",
        text: "Imaginative and inspiring",
        emoji: "🌈",
        category: "creator",
      },
      {
        id: "caring",
        text: "Caring and understanding",
        emoji: "🤗",
        category: "helper",
      },
    ],
      ...
      <div className="max-w-2xl w-full">
        ...
        <Card
          className={`glass-card p-8 mb-8 ${
            isAnimating ? "animate-scale-in" : "animate-slide-up"
          }`}
        >
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-slate-400">{question.subtitle}</p>
          </div>
        ...
        <div className="flex justify-between items-center animate-slide-up">
          <Button
            ...
            className="glass-card border-indigo-400/30"
          >
            Previous
          </Button>
